module github.com/yaroslavborbat/sandbox-mommy
...
require (
	...
	github.com/yaroslavborbat/sandbox-mommy/api v0.0.0-00010101000000-000000000000
	...
	kubevirt.io/client-go v1.6.0-beta.0
...
replace github.com/yaroslavborbat/sandbox-mommy/api => ./api
