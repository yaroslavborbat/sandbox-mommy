...
func asyncSubresourceHelper(
	...
	req, err := MakeRequest(config.Host, resource, name, namespace, subresource, queryParams)
	if err != nil {
	...
	go func() {
		...
		if response != nil {
			...
			case http.StatusNotFound:
				err = &AsyncSubresourceError{err: "Sandbox not found.", StatusCode: response.StatusCode}
