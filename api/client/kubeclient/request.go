...
const subresourceURLTpl = "/apis/subresources.sandbox.io/v1alpha1/namespaces/%s/%s/%s/%s"

func MakeRequest(host, resource, name, namespace, subresource string, queryParams url.Values) (*http.Request, error) {
